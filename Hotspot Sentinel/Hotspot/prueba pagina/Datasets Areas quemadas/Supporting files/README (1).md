...
## 1. Request Parameters  
    ...
    Date Completed: 2025-10-04T15:45:14.031160  

    ID: c3f560b9-d197-4652-beab-2b1191abc740  
    ...
    Details:  
        ...
        Layers:  
                ...
                FireMask (MOD14A2.061)  
                QA (MOD14A2.061)  
                FireMask (MYD14A2.061)  
                QA (MYD14A2.061)  
...
- Argentina-MOD14A2-061-metadata.xml
- Argentina-MYD14A2-061-metadata.xml
- Argentina-granule-list.txt
- Argentina-request.json
- MOD14A2-061-QA-lookup.csv
- MYD14A2-061-QA-lookup.csv
- MOD14A2-061-QA-Statistics-QA.csv
- MYD14A2-061-QA-Statistics-QA.csv
- MOD14A2-061-FireMask-Statistics.csv
- MYD14A2-061-FireMask-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 4  
Total Size of Extracted Data Files: 2.07 MB  
...
- Giglio, L., Justice, C. (2021). MODIS/Aqua Thermal Anomalies/Fire 8-Day L3 Global 1km SIN Grid V061. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2025-10-04 from https://doi.org/10.5067/MODIS/MYD14A2.061. Accessed October 4, 2025.
- Giglio, L., Justice, C. (2021). MODIS/Terra Thermal Anomalies/Fire 8-Day L3 Global 1km SIN Grid V061. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2025-10-04 from https://doi.org/10.5067/MODIS/MOD14A2.061. Accessed October 4, 2025.
